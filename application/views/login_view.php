...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: black;">Perpustakaan <br/><b>MINU Sumberpasir</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; Teknik Informatika UIN Maliki Malang - 2023</a>
    </div>
  </footer>
</div>
<!-- /.login-box -->
